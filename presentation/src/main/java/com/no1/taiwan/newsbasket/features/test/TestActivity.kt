...
import kotlinx.android.synthetic.main.fragment_list_news.ftv_author
import kotlinx.android.synthetic.main.fragment_list_news.ftv_news_brief
import kotlinx.android.synthetic.main.fragment_list_news.ftv_news_title
import kotlinx.android.synthetic.main.fragment_list_news.ftv_published_at
import kotlinx.android.synthetic.main.fragment_list_news.iv_cover
...
class TestActivity : AdvActivity<TestViewModel>() {
    ...
    override fun provideLayoutId() = R.layout.fragment_list_news
